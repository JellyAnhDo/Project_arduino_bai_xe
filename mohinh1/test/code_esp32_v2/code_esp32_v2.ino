...
TaskHandle_t xTaskManualBarrierControl, xTaskAutomaticBarrierControl;
...
void setup() {
  ...
  xTaskCreatePinnedToCore(TaskSensor, "TaskSensor", 10000, NULL, 0, &xTaskSensor, 0); //tskIDLE_PRIORITY
